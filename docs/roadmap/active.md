...
**Gate (real exit codes, 2026-08-01, after the WiFi form + 13-tool sweep):**
`check 0` · `typecheck 0` · `lint 0` · `test 0 (572)` · `tokens 0 (baseline
re-locked, −620)` · `contrast 0` · **`i18n 0`** · `build 0` · `ext build 0`.
Every gate green for the first time on this branch.
