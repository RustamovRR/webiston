...
![Fiber reconciler’da reconciliation oqimi](/fluent-react/reconciliation-flow.png)
...
![Render bosqichining chaqiruv tartibi](/fluent-react/render-phase.png)
...
![FiberRootNode bilan commit bosqichi](/fluent-react/commit-phase.png)
