---
title: Turli xil operatorlar
description: "Turlanma operatorlar: uchlik `?:`, birinchi aniqlangan `??`, `typeof`, `delete`, `await`, `void` va vergul operatori — sintaksis, ishlash va amaliy misollar."
keywords: JavaScript, uchlik operator, ternary operator, ?:, nullish coalescing, ??, typeof operatori, delete operatori, await operatori, void operatori, vergul operatori, comma operator, turli xil operatorlar, miscellaneous operators, shartli operator, conditional operator
author: Webiston.uz
---
