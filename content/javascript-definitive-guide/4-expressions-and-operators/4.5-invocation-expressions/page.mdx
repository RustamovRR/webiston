---
title: Funksiyani chaqirish ifodalari
description: "Invocation expressions: funksiya/metod chaqiruvlari, `this` konteksti, argumentlar hamda ES2020 shartli chaqiruv `?.()` va short-circuit xususiyatlari."
keywords: JavaScript, chaqiruv, invocation, funksiya chaqiruvi, function call, metod chaqiruvi, method call, this konteksti, this context, argumentlar, arguments, ixtiyoriy zanjir, optional chaining, ?.(), qisqa tutashuv, short-circuit, funksiya bajarish, function execution
author: Webiston.uz
---
