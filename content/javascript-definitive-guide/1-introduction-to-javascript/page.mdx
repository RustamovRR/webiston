...
keywords: JavaScript, ECMAScript, ES6, qat'iy rejim, strict mode, brauzer, browser, Node.js, kirish, introduction, boshlang'ich, beginner, dasturlash, programming, veb dasturlash, web development, til asoslari, language basics
author: Webiston.uz
---
