---
title: Obyektlarni yaratish
description: "JavaScript'da obyekt yaratish usullari: obyekt literallari, new operatori, Object.create() va prototiplar bilan ishlash."
keywords: JavaScript, obyekt yaratish, object creation, obyekt literallari, object literals, new operatori, new operator, Object.create, prototiplar, prototypes, konstruktor funksiyalari, constructor functions, obyekt hosil qilish, creating objects
author: Webiston.uz
---
...
Prototipga ega bo'lmagan yangi obyekt yaratish uchun `null` qiymatini uzatishingiz mumkin. Lekin agar shunday qilsangiz, yangi yaratilgan obyekt hech narsani, hatta `toString()` kabi asosiy metodlarni ham meros qilib olmaydi (bu esa uning `+` operatori bilan ham ishlamasligini anglatadi):
