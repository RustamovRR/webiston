---
title: Sun'iy intellekt muhandisligining yuksalishi
description: "Til modellaridan LLM va fundamental modellarga evolyutsiya. O'z-o'zini nazorat qilish, self-supervision, tokenizatsiya, avtoregressiv va niqoblangan modellar. GPT, BERT, CLIP va multimodal modellarning rivojlanishi. AI engineering yo'nalishining paydo bo'lishi va jadal o'sishi."
keywords: AI Engineering, sun'iy intellekt muhandisligi, AI muhandisligi, til modellari, language models, LLM, large language models, katta til modellari, fundamental modellar, fundamental models, GPT, BERT, CLIP, tokenizatsiya, tokenization, o'z-o'zini nazorat qilish, self-supervision, avtoregressiv, autoregressive, niqoblangan til modellari, masked language models, multimodal, ko'p modalli, embedding, ChatGPT, OpenAI, yuksalish, rise, evolyutsiya, evolution, tarix, history
author: Webiston.uz
---
...
To'ldirish qudratli bo'lsa-da, bu suhbat qurish bilan bir xil narsa emas. Masalan, agar siz to'ldiruvchi mashinaga savol bersangiz, u savolga javob berish o'rniga, sizning gapingizni yana bir savol qo'shish orqali to'ldirishi mumkin. ["Yakuniy o'qitish" (_Post-Training_)](/books/ai-engineering/2-understanding-foundation-models/post-training) bo'limida modelni foydalanuvchi so'roviga qanday qilib munosib javob berishga o'rgatish muhokama qilinadi.
