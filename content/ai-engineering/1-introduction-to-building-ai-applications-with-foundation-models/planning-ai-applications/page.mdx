...
Ko'pgina o'zgarishlar ijobiydir. Masalan, ko'plab modellarning cheklovlari bartaraf etilmoqda. Kontekst uzunliklari uzayib bormoqda. Model natijalari yaxshilanmoqda. Model `inference`'i, ya'ni kirish ma'lumoti asosida chiqish natijasini hisoblash jarayoni, tezlashmoqda va arzonlashmoqda. 1-11-rasmda 2022 va 2024-yillar oralig'ida `inference` xarajatlari va modelning ommabop fundamental modellar benchmark'i bo'lgan Keng Qamrovli Ko'p Vazifali Til Tushunish (`MMLU`) ([Hendrycks va boshq., 2020](https://arxiv.org/abs/2009.03300)) bo'yicha samaradorligining evolyutsiyasi ko'rsatilgan.
