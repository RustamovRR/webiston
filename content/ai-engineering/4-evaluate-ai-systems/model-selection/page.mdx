...
[^11]: Ruhan, bu cheklov ["Elastic" litsenziyasiga](https://www.elastic.co/licensing/elastic-license) o'xshaydi, u kompaniyalarga "Elastic"ning ochiq manbali versiyasini `host` qilingan xizmat sifatida taklif qilishni va "Elasticsearch" platformasi bilan raqobatlashishni taqiqlaydi.
...
[^16]: Dunyo bo'ylab qoidalar rivojlanib borayotgani sababli, modellar va o'qitish ma'lumotlarining tekshiriladigan (`auditable`) axborotiga bo'lgan talablar ortishi mumkin. Tijoriy modellar sertifikatlar taqdim eta olishi va kompaniyalarni bu harakatdan qutqarishi mumkin.
