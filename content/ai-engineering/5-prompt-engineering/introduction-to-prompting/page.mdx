...
_Prompting ishlashi uchun model ko'rsatmalarga amal qila olishi kerak_. Agar model bu borada yomon ishlasa, promptingiz qanchalik yaxshi bo'lishidan qat'i nazar, model unga amal qila olmaydi. Modelning ko'rsatmalarga amal qilish qobiliyatini qanday baholash [4-bobda](/books/ai-engineering/4-evaluate-ai-systems) muhokama qilingan.
...
Modellarga promptlar orqali nima qilishni o'rgatish, shuningdek, **kontekstual o'rganish** (_in-context learning_) deb ham ataladi. Bu atama Brown va boshqalar (2020) tomonidan `GPT-3` haqidagi [“Til Modellari — Kam Misolli O'rganuvchilardir” (“Language Models Are Few-shot Learners”)](https://arxiv.org/abs/2005.14165) nomli maqolada ilk bor qo'llanilgan. An'anaviy usulda, model kerakli xatti-harakatni o'qitish — jumladan, dastlabki o'qitish, qo'shimcha o'qitish va _finetuning_ — davomida o'rganadi, bu esa model parametrlarini (_weights_) yangilashni o'z ichiga oladi. `GPT-3` haqidagi maqolada esa til modellari kerakli xatti-harakatni promptdagi misollardan o'rgana olishi namoyish etilgan, hatto bu xatti-harakat model dastlab o'qitilgan vazifadan farq qilsa ham. Bunda parametrlarni yangilash talab etilmaydi. Aniqroq aytganda, `GPT-3` keyingi tokenni bashorat qilish uchun o'qitilgan, lekin maqolada `GPT-3` kontekstdan foydalanib tarjima qilishni, o'qib tushunishni, oddiy matematik amallarni bajarishni va hatto SAT imtihoni savollariga javob berishni o'rgana olishi ko'rsatilgan.
...
Tizim prompti, foydalanuvchi prompti, misollar va kontekst — bular promptning asosiy tarkibiy qismlaridir. Endi biz prompt nima ekanligi va prompting nima uchun ishlashini muhokama qilib bo'lganimizdan so'ng, keling, samarali promptlar yozishning eng yaxshi amaliyotlarini ko'rib chiqamiz.

#### Izohlar

[^2]: 2023-yil oxirida Stanford o'zining `HELM Lite` benchmarkidan chidamlilik metrikasini olib tashladi.

[^3]: Odatda, kutilgan chat andozasidan chetga chiqishlar modelning ishlash samaradorligi yomonlashishiga olib keladi. Biroq, kamdan-kam hollarda bo'lsa-da, bu holat modelning yaxshiroq ishlashiga ham sabab bo'lishi mumkin, bu haqda Reddit'dagi bir muhokamada aytib o'tilgan.

[^4]: Agar GitHub va Reddit'da yetarlicha vaqt o'tkazsangiz, chat andozalarining mos kelmasligi bilan bog'liq ko'plab muammolarga duch kelasiz, masalan, mana bu holat kabi. Bir safar _finetuning_ bilan bog'liq muammoni tuzatishga bir kunimni sarflaganman va yakunda anglab yetgandimki, bunga men ishlatgan kutubxona modelning yangi versiyasi uchun chat andozasini yangilamagani sabab bo'lgan ekan.

[^5]: Foydalanuvchilar andoza bilan bog'liq xatolarga yo'l qo'ymasligi uchun ko'plab model _API_'lari shunday loyihalashtirilganki, foydalanuvchilarning o'zlari maxsus andoza tokenlarini yozishiga hojat qolmaydi.
...
[^7]: Shreya Shankar shifokor qabuliga borish uchun o'tkazgan amaliy NIAH sinovi haqida ajoyib maqola yozgan (2024).

[^8]: Eslatib o'tamiz, 2-bobda muhokama qilinganidek, til modelining o'zi foydalanuvchi tomonidan kiritilgan ma'lumot va o'zining generatsiyasi o'rtasidagi farqni ajrata olmaydi.

[^9]: Bu parallel qayta ishlash misoli Anthropic'ning prompt muhandisligi qo'llanmasidan olingan.

[^10]: Modelning promptlar yozish qobiliyati, ehtimol, uning internetda ulashilgan promptlar asosida o'qitilgani tufayli kuchaygan.

[^11]: Hamel Husain bu falsafani o'zining “Show Me the Prompt” (14-fevral, 2024-yil) nomli blog postida ajoyib tarzda tizimlashtirgan.

[^12]: Brend obro'siga putur yetkazishi va dezinformatsiyaga olib kelishi mumkin bo'lgan javoblar 4-bobda qisqacha muhokama qilingan.

[^13]: Shunday masofadan kod ijro etish xavflaridan biri 2023-yilda LangChain'da aniqlangan. GitHub'dagi 814 va 1026-sonli masalalarga qarang.

[^14]: Mashhur promptlar ro'yxatlari qatoriga `f/awesome-chatgpt-prompts` (inglizcha promptlar) va `PlexPt/awesome-chatgpt-prompts-zh` (xitoycha promptlar) kiradi. Yangi modellar chiqishi bilan ulardagi promptlar qancha vaqt o'z dolzarbligini saqlab qolishi haqida hech qanday tasavvurga ega emasman.

[^15]: Balki xususiy promptlarni xuddi kitob kabi patentlash mumkindir, lekin biror pretsedent bo'lmaguncha, bu haqda biror nima deyish qiyin.
...
[^18]: _SQL_ jadvallarini tozalash haqida gapirganda, `xkcd`'ning mana bu klassik komiksini eslamaslikning iloji yo'q: “Bir onaning "qahramonliklari"”.
