---
title: Aniq baholash
description: "Aniq baholash: funksional to'g'rilik, etalon ma'lumotlarga nisbatan o'xshashlik. Kod generatsiyasi, unit testlar, HumanEval, MBPP, Spider, BIRD-SQL. O'xshashlik o'lchovlari: BLEU, ROUGE, METEOR, BERTScore."
keywords: aniq baholash, exact evaluation, funksional to'g'rilik, functional correctness, bajarilish aniqligi, execution accuracy, kod generatsiyasi, code generation, unit testlar, unit tests, HumanEval, MBPP, Spider, BIRD-SQL, WikiSQL, o'xshashlik o'lchovlari, similarity metrics, BLEU, ROUGE, METEOR, BERTScore, etalon ma'lumotlar, ground truth, SI muhandisligi, AI muhandisligi, sun'iy intellekt muhandisligi
author: Webiston.uz
---
