...
[^35]: Ba'zi _finetuning_ xizmatlari buni siz uchun avtomatik ravishda bajaradi. "OpenAI"ning _finetuning_ xizmatlari avval o'qitish paytida klassifikator boshi qo'shishga imkon berardi, ammo men yozayotgan vaqtda bu xususiyat o'chirib qo'yilgan.
