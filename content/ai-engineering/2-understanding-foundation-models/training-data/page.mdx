...
![2-1-rasm. _MMLU_ mezonida `GPT-4` boshqa har qanday tilga qaraganda ingliz tilida yaxshiroq ishlaydi. Boshqa tillardagi _MMLU_ testini olish uchun "OpenAI" savollarni "Azure AI Translator" yordamida tarjima qilgan.](/ai-engineering/2-chapter/2.1-figure.png)
