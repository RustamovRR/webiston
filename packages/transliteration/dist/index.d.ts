 ...
 */
declare function detectScript(text: string): ScriptType;
/**
 * Check if text is primarily Latin script
 */
declare function isLatinText(text: string): boolean;
 ...
 */
declare function isLowerCase(char: string): boolean;
/**
 * Preserve the case pattern from source to target
 * Handles single chars and multi-char strings (digraphs)
 */
declare function preserveCase(source: string, target: string): string;
/**
 * Check if character is a vowel (Latin)
 */
declare function isLatinVowel(char: string): boolean;
/**
 * Check if character is a vowel (Cyrillic - Uzbek + Russian)
 */
declare function isCyrillicVowel(char: string): boolean;
/**
 * Check if position is at word boundary
 * Word boundary = start of text, or after space/punctuation
 */
declare function isWordBoundary(text: string, index: number): boolean;
...
export { APOSTROPHE_VARIANTS, type CharacterMapping, type DigraphMapping, NON_TRANSLITERATABLE_WORDS, type ScriptType, type TransliterationDirection, type TransliterationMode, type TransliterationOptions, UZBEK_SUFFIXES, detectScript, isCyrillicText, isCyrillicVowel, isLatinText, isLatinVowel, isLowerCase, isUpperCase, isWordBoundary, normalizeApostrophes, preserveCase, toCyrillic, toLatin };
