  ...
  return (
    <div className="mt-8 rounded-xl border border-zinc-200 bg-white/80 p-6 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/80">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          <h4 className="mb-3 font-medium text-zinc-800 dark:text-zinc-200">{t('securityRulesTitle')}</h4>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg bg-blue-500/10 p-4">
          <div className="mb-2 font-medium text-blue-600 dark:text-blue-400">{t('randomTitle')}</div>
          <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('randomDesc')}</div>
        </div>

        <div className="rounded-lg bg-purple-500/10 p-4">
          <div className="mb-2 font-medium text-purple-600 dark:text-purple-400">{t('memorableTitle')}</div>
          <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('memorableDesc')}</div>
        </div>

        <div className="rounded-lg bg-green-500/10 p-4">
          <div className="mb-2 font-medium text-green-600 dark:text-green-400">{t('strongTitle')}</div>
          <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('strongDesc')}</div>
        </div>
      </div>
    </div>
  )
