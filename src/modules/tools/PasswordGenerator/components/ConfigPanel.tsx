        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="space-y-3">
            ...
            <GradientTabs
              ...
              onChange={(value) =>
                onUpdateSettings({
                  passwordType: value as "random" | "memorable" | "strong"
                })
              }
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onUpdateSettings({ includeUppercase: e.target.checked })
                }
                className="sr-only"
              />
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onUpdateSettings({ includeLowercase: e.target.checked })
                }
                className="sr-only"
              />
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onUpdateSettings({ includeNumbers: e.target.checked })
                }
                className="sr-only"
              />
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onUpdateSettings({ includeSymbols: e.target.checked })
                }
                className="sr-only"
              />
          ...
          >
            <input
              ...
              onChange={(e) =>
                onUpdateSettings({ excludeSimilar: e.target.checked })
              }
              className="sr-only"
            />
