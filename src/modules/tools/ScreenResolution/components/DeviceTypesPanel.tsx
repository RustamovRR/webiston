...
const DeviceTypesPanel: React.FC<DeviceTypesPanelProps> = ({ deviceTypes, currentDeviceType }) => {
        ...
        {deviceTypes.map((device, index) => (
          ...
          >
            <div>
              ...
              <div className="text-xs text-zinc-500 dark:text-zinc-500">{device.range}</div>
            </div>
            {currentDeviceType === device.name && (
