...
const ModeInfoPanel: React.FC<ModeInfoPanelProps> = ({ isFullscreen, analysis }) => {
  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white/50 p-6 dark:border-zinc-800 dark:bg-zinc-900/50">
      ...
      <div className="space-y-4">
        ...
        >
          <span className="text-zinc-700 dark:text-zinc-300">{t('fullscreenMode')}</span>
          <div
        ...
        {analysis && (
          ...
          >
            <span className="text-zinc-700 dark:text-zinc-300">{t('retinaDisplay')}</span>
            <div
        ...
        {analysis && (
          <div className="rounded-lg bg-zinc-100/50 p-3 dark:bg-zinc-800/30">
            <div className="mb-1 text-sm text-zinc-600 dark:text-zinc-400">{t('viewportRatio')}</div>
            <div className="text-lg font-semibold text-cyan-600 dark:text-cyan-400">{analysis.viewportRatio}%</div>
          </div>
        )}
      </div>
    </div>
