...
// Shared Components
import { ToolHeader, UniversalDualPanel, createCustomPanel, CopyButton } from '@/components/shared'

// Utils & Hooks
import { useColorConverter } from '@/hooks/tools/useColorConverter'
...
const ColorConverter = () => {
  ...
  const handleDownloadPalette = () => {
    ...
    const content = [
      ...
      '',
      '## Generated Palette:',
      ...generatedPalette.map((color, index) => `${index + 1}. ${color} - ${getColorName(color)}`),
      '',
      '---',
      'Generated by Webiston.uz Color Converter',
    ].join('\n')
          ...
          {colorFormats?.isValid && (
            <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-4">
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-lg border border-zinc-700" style={{ backgroundColor: inputColor }} />
                <div>
      ...
      <UniversalDualPanel
        sourcePanel={createCustomPanel(
          ...
          colorFormats?.isValid
            ...
            : { type: 'error', message: "Noto'g'ri format" },
          inputStats,
        )}
        targetPanel={createCustomPanel(
          "Formatlar va Ma'lumotlar",
          renderFormatsContent(),
          colorFormats?.isValid ? { type: 'success' } : { type: 'ready' },
          outputStats,
