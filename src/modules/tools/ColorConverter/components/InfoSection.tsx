        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/30">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <code className="text-sm text-zinc-700 dark:text-zinc-300">#FF0000</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-blue-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">#0000FF</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-green-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">#00FF00</code>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/30">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-red-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">rgb(255, 0, 0)</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-blue-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">rgb(0, 0, 255)</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-green-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">rgb(0, 255, 0)</code>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/30">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-red-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">hsl(0, 100%, 50%)</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-blue-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">hsl(240, 100%, 50%)</code>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-green-500" />
                <code className="text-sm text-zinc-700 dark:text-zinc-300">hsl(120, 100%, 50%)</code>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-3">
            ...
            <ul className="space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
              <li>• {t('about.hex.desc1') || 'Web dasturlashda eng keng tarqalgan'}</li>
              <li>• {t('about.hex.desc2') || '#RRGGBB formatida (6 ta belgi)'}</li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li>• {t('about.rgb.desc2') || "0-255 oralig'ida har bir kanal"}</li>
              <li>• {t('about.rgb.desc3') || 'Monitor va ekranlar uchun'}</li>
              <li>• {t('about.rgb.desc4') || 'JavaScript da keng ishlatiladi'}</li>
            </ul>
          </div>
          <div className="space-y-3">
            <h4 className="flex items-center gap-2 font-semibold text-zinc-800 dark:text-zinc-200">
            ...
            <ul className="space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li>• {t('about.hsl.desc3') || "CSS3 da qo'llab-quvvatlanadi"}</li>
              <li>• {t('about.hsl.desc4') || 'Rang moslamalari uchun qulay'}</li>
            </ul>
          </div>
        </div>
      </div>
