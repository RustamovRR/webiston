          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>
                  <strong>{t('useCases.podcasting.title')}</strong> {t('useCases.podcasting.description')}
                </span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-purple-500"></div>
                <span>
                  <strong>{t('useCases.streaming.title')}</strong> {t('useCases.streaming.description')}
                </span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-orange-500"></div>
                <span>
                  <strong>{t('useCases.voiceOver.title')}</strong> {t('useCases.voiceOver.description')}
                </span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-cyan-500"></div>
                <span>
                  <strong>{t('useCases.remoteWork.title')}</strong> {t('useCases.remoteWork.description')}
                </span>
              </li>
            </ul>
          </div>
