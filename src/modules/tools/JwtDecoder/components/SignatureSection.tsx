...
const SignatureSection: React.FC<SignatureSectionProps> = ({ signature }) => {
  ...
  return (
    <div className="mt-6 rounded-lg border border-zinc-200 bg-white/80 backdrop-blur-sm dark:border-zinc-800/30 dark:bg-zinc-900/60">
      ...
      <div className="relative min-h-[120px]">
        <div className="p-4">
          ...
          <pre className="rounded bg-zinc-100 p-3 font-mono text-sm break-all whitespace-pre-wrap text-zinc-800 dark:bg-zinc-800/50 dark:text-zinc-200">
            {signature}
          </pre>
        </div>
      </div>
