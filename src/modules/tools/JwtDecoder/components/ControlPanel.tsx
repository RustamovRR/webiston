...
import { Eye, EyeOff, FileText, ChevronDown, Upload, Key, CheckCircle, Info, ChevronUp } from 'lucide-react'
        ...
        >
          <div className="mt-4 rounded-lg border border-blue-200/50 bg-blue-50/30 p-3 dark:border-blue-800/20 dark:bg-blue-900/10">
            <div className="space-y-2 text-sm">
              <p>
                <strong className="text-blue-700 dark:text-blue-300">{tInfo('decoded')}:</strong>{' '}
                <span className="text-blue-600/90 dark:text-blue-200/90">{tInfo('decodedDescription')}</span>
              </p>
              <p>
                <strong className="text-blue-700 dark:text-blue-300">{tInfo('raw')}:</strong>{' '}
                <span className="text-blue-600/90 dark:text-blue-200/90">{tInfo('rawDescription')}</span>
              </p>
            </div>
          </div>
        </div>
