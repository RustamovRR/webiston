...
const HTTP_STATUS_CODES: HttpStatusCode[] = [
  ...
  },
  {
    ...
    title: "Processing",
    description:
      "Server so'rovni qayta ishlayapti, ammo hali javob tayyor emas",
    category: "informational",
    rfc: "RFC 2518",
...
export const useHttpStatus = () => {
  ...
  const [selectedStatus, setSelectedStatus] = useState<HttpStatusCode | null>(
    null
  )
