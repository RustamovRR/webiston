              ...
              {result ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-4">
                          {[
                            {
                              label: "DNS Qidiruv",
                              value: result.performance.dns,
                              color: "bg-blue-500"
                            },
                            {
                              label: "Ulanish",
                              value: result.performance.connection,
                              color: "bg-green-500"
                            },
                            {
                              label: "TLS Handshake",
                              value: result.performance.tls,
                              color: "bg-purple-500"
                            },
                            {
                              label: "TTFB",
                ...
                <div className="flex h-40 items-center justify-center text-zinc-500">
                  <div className="text-center">
                    ...
                    <p>
                      Website holatini tekshirish uchun chap paneldan
                      foydalaning
                    </p>
                  </div>
                </div>
      ...
      <div className="mt-12 space-y-8">
        <div className="text-center">
          <h2 className="mb-4 text-3xl font-bold text-zinc-100">
            Website Status Checker Haqida
          </h2>
          <p className="mx-auto max-w-2xl text-lg text-zinc-400">
            Professional website monitoring va performance tahlil vositasi.
            Real-time sayt holati, server javob vaqti va SSL sertifikat
            tekshiruvi.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8">
            ...
            <p className="mb-6 text-zinc-400">
              Website holatini real-time tekshirish va tahlil qilish:
            </p>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8">
            ...
            <p className="mb-6 text-zinc-400">
              Server va tarmoq performance'ini batafsil tahlil qilish:
            </p>
            <ul className="space-y-3 text-sm text-zinc-400">
              <li className="flex items-center gap-3">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8">
            ...
            <p className="mb-6 text-zinc-400">
              Website xavfsizlik holatini comprehensive tahlil qilish:
            </p>
            <ul className="space-y-3 text-sm text-zinc-400">
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                <code className="rounded bg-teal-500/20 px-2 py-1 text-teal-300">
                  Protocol
                </code>
                <span>HTTP/HTTPS protokol aniqlash</span>
              </li>
              <li className="flex items-center gap-3">
                <code className="rounded bg-violet-500/20 px-2 py-1 text-violet-300">
                  Headers
                </code>
                <span>HTTP header ma'lumotlari</span>
              </li>
              <li className="flex items-center gap-3">
                <code className="rounded bg-emerald-500/20 px-2 py-1 text-emerald-300">
                  Expires
                </code>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8">
          <h3 className="mb-6 text-xl font-semibold text-zinc-100">
            API Integratsiya va Ma'lumot Manbalari
          </h3>
          <p className="mb-8 text-zinc-400">
            Website Status Checker professional API'lar bilan integratsiya
            qilingan va real-time ma'lumotlar bilan ishlaydi:
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-6">
              ...
              <p className="mb-3 text-sm text-zinc-400">
                Professional website monitoring service bilan real-time ma'lumot
                olish imkoniyati.
              </p>
              <code className="text-xs text-green-300">
                HTTP request monitoring integratsiyasi
              </code>
            </div>
            ...
            <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-6">
              ...
              <p className="mb-3 text-sm text-zinc-400">
                DNS, Connection, TLS va TTFB metrikalarini professional tahlil
                qilish.
              </p>
            ...
            <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-6">
              ...
              <p className="mb-3 text-sm text-zinc-400">
                HTTPS protokol va SSL sertifikat validatsiyasi bilan xavfsizlik
                tahlili.
              </p>
            ...
            <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-6">
              ...
              <p className="mb-3 text-sm text-zinc-400">
                Tahlil natijalarini JSON formatda yuklab olish imkoniyati.
              </p>
              <code className="text-xs text-orange-300">
                Strukturaviy ma'lumot eksport funksiyasi
              </code>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <h4 className="mb-4 font-semibold text-zinc-200">
                Veb Dasturlash va DevOps
              </h4>
              <ul className="space-y-3 text-sm text-zinc-400">
        ...
        <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-8">
          <h4 className="mb-4 font-semibold text-blue-200">
            Professional Maslahatlar
          </h4>
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <p className="text-sm text-blue-100">
                <strong>CORS Cheklovi:</strong> Ba'zi saytlar browser'dan
                to'g'ridan-to'g'ri tekshirilmasligi mumkin. Bunday holatlarda
                proxy service yoki server-side checking tavsiya etiladi.
              </p>
            </div>
            <div>
              <p className="text-sm text-blue-100">
