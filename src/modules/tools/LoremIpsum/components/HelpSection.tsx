        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
            <li className="flex items-start gap-2">
              ...
              <div>
                <strong>{t('usagePlaces.webDesign.title')}</strong> {t('usagePlaces.webDesign.desc')}
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-green-500"></div>
              <div>
                <strong>{t('usagePlaces.graphicDesign.title')}</strong> {t('usagePlaces.graphicDesign.desc')}
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-purple-500"></div>
              <div>
                <strong>{t('usagePlaces.typography.title')}</strong> {t('usagePlaces.typography.desc')}
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-orange-500"></div>
              <div>
                <strong>{t('usagePlaces.prototyping.title')}</strong> {t('usagePlaces.prototyping.desc')}
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-cyan-500"></div>
              <div>
                <strong>{t('usagePlaces.testing.title')}</strong> {t('usagePlaces.testing.desc')}
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-pink-500"></div>
              <div>
                <strong>{t('usagePlaces.placeholder.title')}</strong> {t('usagePlaces.placeholder.desc')}
              </div>
            </li>
          </ul>
        </div>
