...
export const getInfoCardsData = (t: TranslationFunction) => [
  {
    ...
    content: (
      <>
        ...
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong>{t("Info.latinAlphabet.specialChars")}:</strong> o', g', sh,
          ch, ng
        </p>
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong>{t("Info.latinAlphabet.feature")}:</strong>{" "}
          {t("Info.latinAlphabet.featureDesc")}
        </p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong>{t("Info.cyrillicAlphabet.feature")}:</strong>{" "}
          {t("Info.cyrillicAlphabet.featureDesc")}
        </p>
      </>
    )
  },
      ...
      <>
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong className="text-zinc-800 dark:text-zinc-300">
            {t("Info.history.period1")}
          </strong>
        </p>
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong className="text-zinc-800 dark:text-zinc-300">
            {t("Info.history.period2")}
          </strong>
        </p>
        <p className="text-zinc-700 dark:text-zinc-300">
          <strong className="text-zinc-800 dark:text-zinc-300">
            {t("Info.history.period3")}
          </strong>
        </p>
        <p className="mt-3 text-xs text-zinc-500 dark:text-zinc-400">
          {t("Info.history.note")}
