      ...
      <div className="p-6">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            >
              <div
                className={`h-2 w-2 rounded-full ${deviceInfo.touchSupport ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              {deviceInfo.touchSupport
                ? t("touchSupported")
                : t("touchNotSupported")}
          ...
          <div>
            ...
            >
              <div
                className={`h-2 w-2 rounded-full ${deviceInfo.isMobile ? "bg-green-500" : "bg-zinc-500"}`}
              ></div>
