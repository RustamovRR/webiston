  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white/80 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/80">
      <div className="flex items-center justify-between border-b border-zinc-200 px-6 py-4 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          <CopyButton text={JSON.stringify(screenInfo, null, 2)} size="sm" variant="ghost" />
      ...
      <div className="p-6">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('availableSize')}</div>
            <div className="mt-1 text-zinc-900 dark:text-zinc-100">
              {screenInfo.availWidth} × {screenInfo.availHeight} px
            </div>
          </div>
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('colorDepth')}</div>
            <div className="mt-1 text-zinc-900 dark:text-zinc-100">{screenInfo.colorDepth} bit</div>
          </div>
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('pixelRatio')}</div>
            <div className="mt-1 text-zinc-900 dark:text-zinc-100">{screenInfo.pixelRatio}x</div>
          </div>
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-400">{t('orientation')}</div>
            <div className="mt-1 text-zinc-900 capitalize dark:text-zinc-100">{screenInfo.orientation}</div>
          </div>
        </div>
      </div>
    </div>
