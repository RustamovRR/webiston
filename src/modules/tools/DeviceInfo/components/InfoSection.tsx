          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
              <li className="flex items-center gap-2">
                ...
                <strong>{t('usagePlaces.webDev.title')}</strong> {t('usagePlaces.webDev.desc')}
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-pink-500"></div>
                <strong>{t('usagePlaces.browserTesting.title')}</strong> {t('usagePlaces.browserTesting.desc')}
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-orange-500"></div>
                <strong>{t('usagePlaces.performance.title')}</strong> {t('usagePlaces.performance.desc')}
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-cyan-500"></div>
                <strong>{t('usagePlaces.analytics.title')}</strong> {t('usagePlaces.analytics.desc')}
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-green-500"></div>
                <strong>{t('usagePlaces.support.title')}</strong> {t('usagePlaces.support.desc')}
              </li>
            </ul>
          </div>
