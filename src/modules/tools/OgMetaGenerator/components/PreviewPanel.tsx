...
const PreviewPanel: React.FC<PreviewPanelProps> = ({ previewInfo }) => {
  ...
  return (
    <div className="max-h-[600px] overflow-y-auto rounded-xl border border-zinc-200 bg-white/80 p-6 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/80">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 dark:border-zinc-700 dark:from-blue-900/20 dark:to-indigo-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-blue-600 dark:text-blue-400">{t('facebookPreview')}</span>
            </div>
          ...
          <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-sky-50 to-cyan-50 p-4 dark:border-zinc-700 dark:from-sky-900/20 dark:to-cyan-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-sky-600 dark:text-sky-400">{t('twitterCard')}</span>
            </div>
                ...
                {previewInfo.image && (
                  <div className="mt-2">
                    <img
                      ...
                      onError={(e) => {
                        console.log('Twitter image failed to load:', previewInfo.image)
                        e.currentTarget.style.display = 'none'
                      }}
                    />
                  </div>
          ...
          <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-blue-50 to-purple-50 p-4 dark:border-zinc-700 dark:from-blue-900/20 dark:to-purple-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-blue-600 dark:text-blue-400">{t('telegramPreview')}</span>
            </div>
                ...
                {previewInfo.image && (
                  <div className="mt-2">
                    <img
                      ...
                      onError={(e) => {
                        console.log('Telegram image failed to load:', previewInfo.image)
                        e.currentTarget.style.display = 'none'
                      }}
                    />
                  </div>
          ...
          <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 dark:border-zinc-700 dark:from-blue-900/20 dark:to-indigo-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-blue-600 dark:text-blue-400">{t('linkedinPreview')}</span>
            </div>
              ...
              {previewInfo.image && (
                <div className="mb-3">
                  <img
                    ...
                    onError={(e) => {
                      console.log('LinkedIn image failed to load:', previewInfo.image)
                      e.currentTarget.style.display = 'none'
                    }}
                  />
                </div>
          ...
          {/* WhatsApp Preview */}
          <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-green-50 to-emerald-50 p-4 dark:border-zinc-700 dark:from-green-900/20 dark:to-emerald-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-green-600 dark:text-green-400">{t('whatsappPreview')}</span>
            </div>
                ...
                {previewInfo.image && (
                  <div className="mt-2">
                    <img
                      ...
                      onError={(e) => {
                        console.log('WhatsApp image failed to load:', previewInfo.image)
                        e.currentTarget.style.display = 'none'
                      }}
                    />
                  </div>
