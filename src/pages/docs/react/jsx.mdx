...
Birinchi navbatda, JSX nimani anglatishini tushunaylik. Biz allaqachon JS — JavaScript ekanligini bilamiz. Shunday qilib, JSX "JavaScript X" degan ma'noni anglatadimi? Masalan, Mac OS X singari. Yoki JSX "JavaScript Xtra" degan ma'noni bildiradimi? Bularni oldindan taxmin qilish oson bo'lishi mumkin, lekin JSX’dagi X harfi JavaScript Sintaksis Kengaytmasini bildiradi. Ba'zida uni JavaScript XML deb ham atashadi.
