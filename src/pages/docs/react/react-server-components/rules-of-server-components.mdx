...
Server komponentlar bilan ishlashda barcha props’lar seriyalashtiriladigan bo'lishi kerak. Buning sababi shundaki, server props’larni seriyalashtirib, ularni klientga yuborishi kerak, avval muhokama qilganimizdek. Shuning uchun props’lar server komponentlarda funksiyalar yoki boshqa seriyalashtirilmaydigan qiymatlar bo'lishi mumkin emas. Bu esa, [5-bobda](/docs/react/powerful-patterns/render-props) ko'rib chiqqanimiz "render props" pattern’ini amalda eskirgan qilib qo'yadi.
