...
Bundan avvalgi va ushbu boblar davomida biz React’ning turli jihatlarini, shu jumladan memoizatsiya, lazy loading, reducerlar va state’ni boshqarish mavzularini muhokama qildik. Turli yondashuvlarning afzalliklari va ehtimoliy kamchiliklarini hamda ularning React ilovalari ishlash samaradorligi va davom ettiriluvchanlik qobiliyatiga qanday ta'sir ko'rsatishi mumkinligini o'rgandik.
