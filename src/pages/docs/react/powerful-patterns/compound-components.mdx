...
Boshqa bir afzallik shundaki, bu pattern vazifalarni ajratish(separation of concerns)ni qo'llab-quvvatlaydi, bu esa dasturlarni vaqt o'tishi bilan ancha yaxshi kengaytirishga yordam beradi.
