...
Endilikda biz yangi sahifalarni darhol yangilanishini, yangi sahifani kutmasdan natijalarni ko'rishni, veb sahifalarni yanada "jonli" va tezkor bo'lishini xohlaymiz. Bu esa o'z navbatida User experience(UX, foydalanuvchi tajribasi) va User interface(UI, foydalanuvchi interfeysi)’ni yanada takomillashtirilishga sabab bo'ldi. Biroq, bu tezkor yangilanishlarni birdaniga keng ko'lamda amalga oshirish bir necha sabablarga ko'ra oson emas edi:
