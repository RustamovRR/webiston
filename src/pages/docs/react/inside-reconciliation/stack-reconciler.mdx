...
Ilgari, React rendering uchun stack ma'lumotlar strukturasidan foydalangan. Biz bir xil tushunchani tasavvur qilayotganimizga ishonch hosil qilish uchun, stack ma'lumotlar strukturasini qisqacha muhokama qilamiz
...
Ushbu misolda, pop metodi stack’ning yuqori elementini (3) olib tashlaydi va uni qaytaradi. Stack array’i hozirda qolgan elementlarni (1 va 2) o'z ichiga oladi.
...
Nega bu holat yuz berganini tezkorlik bilan ko'rib chiqamiz. Buning uchun quyidagi misolni ko'rib chiqamiz, bunda bizda yangilanishlar ro'yxati bor:
...
Bu holda, stack reconciler’i bo'lganda ketma-ket ravishda yangilanishlarni render qilardi, ishni to'xtatish yoki kechiktirish imkoni bo'lmasdi. Agar hisoblash jihatdan og'ir komponent renderingni to'sib qo'ysa, foydalanuvchi kiritishi ekranda kechikish bilan paydo bo'ladi. Bu yomon foydalanuvchi tajribasiga olib keladi, chunki matn maydoni javobsiz bo'lardi. Aksincha, agar hisoblash jihatdan og'ir komponentni render qilishini kechiktirgan holda va ushbu og'ir komponentni render qilishdan ko'ra, foydalanuvchi kiritishini yuqoriroq ustuvorlikka ega yangilanish sifatida tan olish va ekranni yangilash, ko'proq qulay bo'lar edi.
...
Stack reconciler yangilanishlarni ustuvorlikka ajratmagan, bu esa kamroq ahamiyatga ega bo'lgan yangilanishlar ko'proq ahamiyatga ega bo'lgan yangilanishlarni to'sib qo'yishi mumkinligini anglatardi. Masalan, past ustuvorlikdagi tooltip yangilanishi yuqori ustuvorlikdagi matn kiritish yangilanishini to'sib qo'yishi mumkin edi. Virtual daraxtdagi yangilanishlar stack’da qanday qabul qilingan bo'lsa, shunday tartibda amalga oshirilar edi.

React ilovasida virtual daraxtdagi yangilanishlar turli darajadagi ahamiyatlarga ega bo'lishi mumkin. Masalan, formaga input’dagi yangilanish, foydalanuvchi to'g'ridan-to'g'ri input bilan o'zaro aloqada bo'lib, uning javob berishini kutayotgani uchun, postdagi layklar sonini ko'rsatadigan indikator yangilanishidan ko'ra muhimroq bo'lishi mumkin.

Stack reconciler’da yangilanishlar qabul qilingan tartibda bajarilar edi, bu kamroq ahamiyatga ega yangilanishlar ko'proq ahamiyatga ega yangilanishlarni to'sib qo'yishi mumkinligini anglatardi. Masalan, agar form input yangilanishidan oldin layklar sonini hisoblash yangilanishi qabul qilinsa, layklar sonini hisoblash yangilanishi birinchi bo'lib bajariladi va form input yangilanishini to'sib qo'yishi mumkin.

Agar layklar sonini hisoblash yangilanishi uzoq vaqt talab qilsa (masalan, og'ir hisoblash ishlari tufayli), bu foydalanuvchi interfeysida sezilarli kechikish yoki buzilish(jank)ga olib kelishi mumkin, ayniqsa foydalanuvchi yangilanish davomida ilova bilan o'zaro aloqada bo'lsa.
...
Har qanday veb-ilovada barcha yangilanishlar teng darajada muhim emas: tasodifiy kutilmagan bildirishnoma chiqishi button’ni bosilishiga javoban muhim emas, chunki oxirgisi qasddan qilingan harakat bo'lib, darhol javob berishni talab qiladi, holbuki birinchisi hatto kutilmagan va istalmagan bo'lishi mumkin.

Stack reconciler’da yangilanishlarni to'xtatish yoki bekor qilish mumkin emas edi, bu shuni anglatadiki, keraksiz yangilanishlar, masalan toast ko'rsatish kabi, ba’zan foydalanuvchi bilan o'zaro aloqalar evaziga amalga oshirilgan. Bu virtual daraxt va DOM’da keraksiz ishlar bajarilishiga olib kelishi mumkin edi, bu esa ilovaning ishlash samaradorligiga salbiy ta'sir ko'rsatardi.
