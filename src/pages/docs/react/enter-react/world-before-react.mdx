...
# Veb-ilovalar yaratishdagi muammolar
...
Ushbu kod qismini iloji boricha avvalgi veb-ilovalarga o'xshatib yozdik. Buni vaqt o'tishi bilan kengaytirish nimaga olib keladi? Asosan, vaqt o'tishi bilan bunday dasturlarni kengaytirish juda ko'p muammolarni keltirib chiqaradi, bu ularni quyidagicha qiladi:
