...
### Memoizatsiya qilishning afzalliklari
Agar vazifalar ro'yxati katta bo'lsa va komponent tez-tez qayta render qilinsa, bu ilovada ishlashda to'siqlar(bottleneck)ga sabab bo'lishi mumkin. Ushbu komponentni optimallashtirish usullaridan biri uni `React.memo` yordamida memoizatsiya qilishdir:
``` js copy
