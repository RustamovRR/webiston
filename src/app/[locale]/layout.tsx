...
export default async function RootLayout({
  ...
  // Nextra'ga dinamik marshrutlarni ko'rsatmaslik uchun 'tools' va '[locale]'ni filtrlaymiz
  const pageMap = rawPageMap.filter((item) => {
    if ('name' in item) {
      return item.name !== 'tools' && item.name !== '[locale]'
    }
    return true
  })
