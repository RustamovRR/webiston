...
const MicrophoneTest = dynamic(() => import('@/modules/tools').then((mod) => ({ default: mod.MicrophoneTest })), {
  ssr: false,
  loading: () => (
    <div className="mx-auto w-full max-w-7xl px-4 py-6">
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-8 backdrop-blur-sm">
        <div className="text-center">
          ...
          <div className="text-lg text-zinc-400">Mikrofon test yuklanmoqda...</div>
        </div>
      </div>
    </div>
  ),
