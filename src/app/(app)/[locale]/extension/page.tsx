...
import { ExtensionHero } from "@/components/shared/ExtensionHero"
      ...
      <div className="mx-auto w-full max-w-[1536px] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[80ch]">
          ...
          {/* The product, photographed — not drawn. `scripts/store-screenshots.mjs
              ...
              and `images.unoptimized` means that is exactly what ships. The
              theme choice — and why it needs a client leaf — is in the
              component. */}
          <ExtensionHero
            light={`/extension/panel-${locale}-light.webp`}
            dark={`/extension/panel-${locale}-dark.webp`}
            alt={t("screenshotAlt")}
            width={1600}
            height={880}
          />
