 ...
 * React equivalent; every payload here is a constant or a copy string, and
...
import { JsonFormatter } from "@/modules/tools/JsonFormatter"
import {
  applicationSchema,
  generateBreadcrumbSchema,
  getFaqItems,
  getJsonFormatterMetadata
} from "@/modules/tools/JsonFormatter/seo"
 ...
 * value here is a constant or a copy string, so there is no injection path
...
export async function generateMetadata({
  ...
  return withLocale(
    getJsonFormatterMetadata(locale),
    locale,
...
export default async function JsonFormatterPage({
  ...
  return (
    <>
      ...
      <RelatedTools locale={locale} href="/tools/json-formatter" />
    </>
  )
}
