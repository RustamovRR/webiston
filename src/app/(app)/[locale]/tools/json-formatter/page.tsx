    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Ha, bizning JSON formatter to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Ha, bizning JSON formatter katta hajmdagi JSON fayllar bilan ham samarali ishlaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, our JSON formatter is completely free. No limitations or payments required."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, our JSON formatter efficiently handles large JSON files as well."
        }
      ]
    }
  }
