...
const structuredData = {
  ...
  url: "https://webiston.uz/tools/device-info",
  sameAs: [
    "https://webiston.uz/en/tools/device-info",
    "https://webiston.uz/tools/device-info"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Ha, bizning device info tool to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, our device info tool is completely free. No limitations or payments required."
        }
      ]
    }
  }
