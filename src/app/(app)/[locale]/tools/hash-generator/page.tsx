...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Hash Generator - Bepul MD5, SHA256, SHA512 Hash Yaratish | Webiston",
    description:
      "Eng yaxshi bepul hash generator. MD5, SHA1, SHA256, SHA512 kriptografik hash yaratish. Parol, fayl va matn uchun xavfsiz hash.",
    type: "website",
    locale: "uz_UZ",
...
const structuredData = {
  ...
  description:
    "Professional hash generator. MD5, SHA1, SHA256, SHA512 kriptografik hash yaratish uchun bepul vosita.",
  url: "https://webiston.uz/tools/hash-generator",
  sameAs: [
    "https://webiston.uz/en/tools/hash-generator",
    "https://webiston.uz/tools/hash-generator"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "MD5, SHA1, SHA256, SHA512 kabi asosiy kriptografik hash algoritmlari qo'llab-quvvatlanadi."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Ha, bizning hash generator to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Major cryptographic hash algorithms like MD5, SHA1, SHA256, SHA512 are supported."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, our hash generator is completely free. No limitations or payments required."
        }
      ]
    }
  }
