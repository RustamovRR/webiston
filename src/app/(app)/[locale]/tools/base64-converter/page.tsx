...
const structuredData = {
  ...
  description:
    "Professional Base64 converter. Matn va fayllarni Base64 ga encode/decode qilish uchun bepul vosita.",
  url: "https://webiston.uz/tools/base64-converter",
  sameAs: [
    "https://webiston.uz/en/tools/base64-converter",
    "https://webiston.uz/tools/base64-converter"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Har qanday matn, rasm, hujjat va boshqa binary fayllarni Base64 formatiga o'girish mumkin."
        },
        {
          question: "Base64 converter bepulmi?",
          answer:
            "Ha, bizning Base64 converter to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Any text, images, documents and other binary files can be converted to Base64 format."
        },
        {
          question: "Is Base64 converter free?",
          answer:
            "Yes, our Base64 converter is completely free. No limitations or payments required."
        }
      ]
    }
  }
