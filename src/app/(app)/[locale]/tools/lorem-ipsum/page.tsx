...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Lorem Ipsum Generator - Bepul Placeholder Matn Yaratuvchi | Webiston",
    description:
      "Eng yaxshi bepul Lorem Ipsum generator. Placeholder matn, dummy text va dizayn uchun namuna matnlar yaratish. Professional lorem ipsum vositasi.",
    type: "website",
    locale: "uz_UZ",
...
const structuredData = {
  ...
  url: "https://webiston.uz/tools/lorem-ipsum",
  sameAs: [
    "https://webiston.uz/en/tools/lorem-ipsum",
    "https://webiston.uz/tools/lorem-ipsum"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Ha, bizning Lorem Ipsum generator to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, our Lorem Ipsum generator is completely free. No limitations or payments required."
        }
      ]
    }
  }
