...
const structuredData = {
  ...
  alternateName: ['Webiston Tools', 'Developer Tools Collection', 'Free Online Tools'],
  description:
      ...
      questions: [
        {
          ...
          answer: "Ha, Webiston'dagi barcha vositalar to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi.",
        },
        {
        ...
        },
        {
          ...
          answer: "Ha, barcha vositalar mobil qurilmalarda ham to'liq ishlaydi va responsive dizaynga ega.",
        },
      ],
    },
    en: {
      questions: [
        {
          ...
          answer: 'Yes, all tools on Webiston are completely free. No limitations or payments required.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Yes, all tools are completely secure. Data is processed in your browser and not sent anywhere.',
        },
        {
          question: 'Do they work on mobile devices?',
          answer: 'Yes, all tools work perfectly on mobile devices and have responsive design.',
        },
      ],
    },
  }
