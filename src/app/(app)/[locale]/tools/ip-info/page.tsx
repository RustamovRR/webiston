...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Professional IP analyzer. IP manzil, geolokatsiya va ISP ma'lumotlarini tahlil qiling. Bepul!",
...
const structuredData = {
  ...
  url: 'https://webiston.uz/tools/ip-info',
  sameAs: ['https://webiston.uz/en/tools/ip-info', 'https://webiston.uz/tools/ip-info'],
  ...
  review: [
    {
      ...
      reviewBody: "IP manzil va geolokatsiya ma'lumotlarini olish uchun juda foydali vosita. Aniq va tez ishlaydi!",
    },
  ],
}
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer: "Ha, bizning IP analyzer to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi.",
        },
      ],
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer: 'Yes, our IP analyzer is completely free. No limitations or payments required.',
        },
      ],
    },
  }
...
export default async function IpInfoPage({ params }: { params: Promise<{ locale: string }> }) {
