...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Professional mikrofon test. Audio sifatini tekshiring, real-time visualizatsiya ko'ring. Bepul!",
...
const structuredData = {
  ...
  alternateName: ['Microphone Test', 'Audio Test', 'Mic Test', 'Mikrofon Sinash'],
  description:
    'Professional mikrofon test vositasi. Audio sifatini tekshirish, real-time visualizatsiya va yozish uchun bepul tool.',
  url: 'https://webiston.uz/tools/microphone-test',
  sameAs: ['https://webiston.uz/en/tools/microphone-test', 'https://webiston.uz/tools/microphone-test'],
  ...
  review: [
    {
      ...
      reviewBody: 'Mikrofon sifatini tekshirish uchun juda foydali vosita. Real-time visualizatsiya ajoyib!',
    },
  ],
}
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer: "WebM/Opus formatida audio yozish qo'llab-quvvatlanadi. Bu zamonaviy va yuqori sifatli format.",
        },
        {
          question: 'Mikrofon test bepulmi?',
          answer: "Ha, bizning mikrofon test to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi.",
        },
      ],
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer: 'All audio recordings are saved locally on your device. No data is sent to servers.',
        },
        {
          question: 'What audio formats are supported?',
          answer: 'WebM/Opus format audio recording is supported. This is a modern and high-quality format.',
        },
        {
          question: 'Is microphone test free?',
          answer: 'Yes, our microphone test is completely free. No limitations or payments required.',
        },
      ],
    },
  }
...
export default async function MicrophoneTestPage({ params }: { params: Promise<{ locale: string }> }) {
