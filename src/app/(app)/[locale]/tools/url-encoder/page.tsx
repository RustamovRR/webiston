...
const structuredData = {
  ...
  description:
    "Professional URL encoder/decoder. URL manzillarni encode va decode qilish uchun bepul vosita.",
  url: "https://webiston.uz/tools/url-encoder",
  sameAs: [
    "https://webiston.uz/en/tools/url-encoder",
    "https://webiston.uz/tools/url-encoder"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Ha, bizning URL encoder to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Percent encoding - bu URL da maxsus belgilarni % belgisi va hex kod bilan almashtirish usuli."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, our URL encoder is completely free. No limitations or payments required."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Percent encoding is a method to replace special characters in URLs with % sign and hex code."
        }
      ]
    }
  }
