...
const structuredData = {
  ...
  url: "https://webiston.uz/tools/uuid-generator",
  sameAs: [
    "https://webiston.uz/en/tools/uuid-generator",
    "https://webiston.uz/tools/uuid-generator"
  ],
    ...
    uz: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "UUID v4 tasodifiy yaratiladi, UUID v1 esa vaqt va MAC address asosida yaratiladi."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Ha, bizning UUID generator to'liq bepul. Hech qanday cheklov yoki to'lov talab qilinmaydi."
        }
      ]
    },
    en: {
      questions: [
        ...
        },
        {
          ...
          answer:
            "UUID v4 is generated randomly, while UUID v1 is based on timestamp and MAC address."
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, our UUID generator is completely free. No limitations or payments required."
        }
      ]
    }
  }
