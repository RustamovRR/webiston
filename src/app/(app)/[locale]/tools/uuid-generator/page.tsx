...
import {
  ...
  UuidGenerator,
  UuidReference
} from "@/modules/tools/UuidGenerator"
import {
  applicationSchema,
  generateBreadcrumbSchema,
  generateFAQSchema,
  getUuidGeneratorMetadata
} from "@/modules/tools/UuidGenerator/seo"
...
export async function generateMetadata({
  ...
  return withLocale(
    getUuidGeneratorMetadata(locale),
    locale,
...
export default async function UuidGeneratorPage({
  ...
  // The FAQ schema reads the same messages `UuidFaq` renders, so the
  ...
  return (
    <>
      ...
      <UuidReference locale={locale} />
      <UuidFaq locale={locale} />
      <RelatedTools locale={locale} href="/tools/uuid-generator" />
    </>
  )
}
