---
title: 'React server komponentlarda yangilanishlarni amalga oshirish'
description: "RSC’larning ko'plab ijobiy jihatlari bo'lsa-da, e'tibor berish kerak bo'lgan ayrim cheklovlar ham mavjud, ikki xil turdagi komponentlar (server va klient) haqida o'ylash kerak bo'lgan ortiqcha aqliy o'ylashni qabul qilish. Buning sababi shundaki, barcha komponentlar server komponentlari bo'la olmaydi."
---
