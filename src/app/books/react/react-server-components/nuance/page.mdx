---
title: 'React server komponentlarda nozik jihatlar (Nuances)'
description: "Server komponentlari faqat serverda, klient komponentlari esa faqat klientda bajariladi, degan umumiy noto'g'ri tushuncha mavjud. Bu haqiqatga to'g'ri kelmaydi. Server komponentlari faqat serverda bajariladi va React elementlarini ifodalovchi obyektlarni ifoda etadi, lekin klient komponentlari faqat klientda bajarilmaydi.

### "Komponentlar bajarilishi" deganda nima nazarda tutiladi?

Buni chuqurroq tushunishimiz uchun kelin, "Komponentlar bajarilishi", ya'ni _components execute_ deganda nimani anglatishini muhokama qilaylik. "Komponentlar bajarilishi" deganda biz komponentni ifodalovchi funksiya chaqirilishini nazarda tutamiz."
---
