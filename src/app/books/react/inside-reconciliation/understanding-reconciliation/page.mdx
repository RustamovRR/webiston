---
title: 'Reconciliation’ni yaxshiroq tushunish'
description: "Tezda ko'z yugurtirib chiqadigan bo'lsak, React’ning virtual DOM’i bizning kerakli UI holatimizning chizmasidir. React bu chizma yordamida, **_reconciliation(moslashtirish)_** deb ataladigan jarayon orqali, uni berilgan muhitda; odatda veb-brauzerda, lekin boshqa muhitlarda, masalan, terminal, iOS va Android kabi native platformalarda ham amalga oshiradi."
---
