---
title: "Flux arxitekturasi"
description: "Flux — bu Facebook (hozirgi Meta) tomonidan ommalashtirilgan, klient tomonidagi (client-side) veb-ilovalarni yaratish uchun mo'ljallangan arxitekturaviy dizayn pattern hisoblanadi(rasmga qarang). U ilova ichidagi ma'lumotlar oqimini prognozli qilish uchun bir tomonlama ma'lumot oqimini ta'minlaydi.
