...
Pishloq qo'shishni kiritamiz, lekin bu safar server va klient komponentlarini aralashtirgan holda. Bu, shuningdek, formani yuborishga javoban darhol *spinner* yoki shunga o'xshash narsalar bilan javob qaytarishga yordam beradi. Buning uchun biz yangi komponent, *./app/AddCheeseForm.tsx*ni yaratamiz:
``` js copy
"use client";
