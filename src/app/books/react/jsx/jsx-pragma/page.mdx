---
title: 'JSX Pragma haqida'
description: "Hamma narsa `<` bilan boshlanadi, bu o'z-o'zidan JavaScript’da taqqoslash amallaridan tashqarida ishlatilganda tanib bo'lmaydigan belgi hisoblanadi. JavaScript dvigateli bunga duch kelganda, `SyntaxError: Unexpected token '<'` xatosini chiqaradi. JSX'da esa bu "JSX pragma" funksiya chaqiruviga transpilyatsiya qilinadi.
