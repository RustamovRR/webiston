---
title: "Reactda Real DOM’ning ayrim kamchiliklari"
description: "Real DOM'ning bir qancha kamchiliklari bor, bu esa yuqori samarador veb-ilovani yaratishni qiyinlashtirishi mumkin. Bu kamchiliklardan ba'zilari ishlash samaradorligiga doir muammolari, brauzerlararo moslik va xavfsizlik zaifliklarini o'z ichiga oladi, bu yerda DOM’ni to'g'ridan-to'g'ri o'zgartirish, cross-site scripting (XSS) zaifliklarini keltirib chiqarishi mumkin.
