---
title: "Dokument fragmentlari (Document fragments) haqida"
description: "Ko'rib o'tganimizdek, DOM’ni to'g'ridan-to'g'ri manipulatsiya qilish keragidan ortiqcha ko'p ishlash muammosiga olib kelish mumkin, ayniqsa bu bir nechta o'zgarishlarni jalb qilganda. Har safar DOM yangilanganda, brauzer qayta joylashuvni hisoblash, UI’ni qayta chizish va ko'rinishni yangilash kabi jarayonlarni bajarishi mumkin, bu esa ilovaning sekinlashishiga olib kelishi mumkin. Dokument fragmentlari bu yerda yordamga keladi.
