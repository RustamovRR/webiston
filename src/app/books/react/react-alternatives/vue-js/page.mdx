---
title: 'Vue.js haqida'
description: "Vue.js foydalanuvchi interfeyslarini yaratish uchun mo'ljallangan mashhur JavaScript freymvorkidir. Uni sobiq Google muhandisi Evan Yu ishlab chiqdi. AngularJS bilan ishlash tajribasiga ega bo'lgan Evan, Angular'ning yaxshi tomonlarini olib, yengilroq, oson qo'llab-quvvatlanadigan va kamroq qattiq qoidalarga ega bo'lgan Vue.js freymvorkini yaratdi.
