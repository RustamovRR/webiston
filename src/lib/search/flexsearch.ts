...
class SearchEngine {
  ...
  private addFallbackDocuments() {
    const fallbackDocs: SearchDocument[] = [
      ...
      },
      {
        ...
        category: 'tools',
        tags: ['json', 'formatter', 'validator', 'prettify', 'syntax', 'javascript', 'api', 'data'],
      },
      {
        ...
        category: 'tools',
        tags: ['url', 'encoder', 'decoder', 'percent-encoding', 'web', 'http', 'uri'],
      },
      {
        ...
        category: 'tools',
        tags: ['base64', 'converter', 'encoder', 'decoder', 'binary', 'data', 'file'],
      },
      {
      ...
      },
      {
        ...
        category: 'tools',
        tags: ['password', 'generator', 'security', 'random', 'cryptography', 'authentication'],
      },
      {
      ...
      },
      {
        ...
        category: 'books',
        tags: ['react', 'basics', 'jsx', 'components', 'props', 'state', 'beginner'],
      },
      {
        id: 'react-hooks',
        title: 'React Hooks',
      ...
      },
      {
        ...
        category: 'books',
        tags: ['react', 'performance', 'optimization', 'memo', 'useMemo', 'useCallback'],
      },
    ]
  ...
  async search(query: string): Promise<ISearchHit[][]> {
    ...
    try {
      ...
      // Sort by relevance
      hits.sort((a, b) => ((b as any)._relevance || 0) - ((a as any)._relevance || 0))
